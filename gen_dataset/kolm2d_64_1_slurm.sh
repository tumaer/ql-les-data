...
#SBATCH --error=jobs/kolm2d_%A_%a.out
#SBATCH --array=0-19
#SBATCH --ntasks=1
...
#     com.dst_path=$DATA_ROOT/raw/2D_KOLM_4096_200kevery1/traj_${seed}
...
# Launch with 
# sbatch kolm2d_64_1_slurm.sh

# Create dataset with
# python gen_dataset.py --split=2_1_1 --skip_first_n_frames=1000 --slice_every_nth_frame=1 \
#     --src_dir=$DATA_ROOT/raw/2D_KOLM_4096_200kevery1/ \
#     --dst_dir=$DATA_ROOT/datasets/2D_KOLM_4096_200kevery1/
# python gen_dataset.py --split=2_1_1 --skip_first_n_frames=1000 --slice_every_nth_frame=10 \
#     --src_dir=$DATA_ROOT/raw/2D_KOLM_4096_200kevery1/ \
