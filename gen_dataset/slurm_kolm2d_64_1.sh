...
python gen_dataset/jaxsph_main.py config=jaxsph_cases/rlx.yaml seed=$seed case.dim=2 case.dx=0.0981747704 \
...
# # Create dataset
# python gen_dataset/gen_dataset.py --split=2_1_1 --skip_first_n_frames=0 --slice_every_nth_frame=1 \
#     --src_dir=$DATA_ROOT/raw/2D_KOLM_4096_140kevery1/ \
#     --dst_dir=$DATA_ROOT/datasets/2D_KOLM_4096_140kevery1/

# python gen_dataset/gen_dataset.py --split=2_1_1 --skip_first_n_frames=0 \
#     --dst_dir=$DATA_ROOT/datasets/2D_KOLM_4096_140kevery1 \
